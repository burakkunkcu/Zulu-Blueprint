...
public class ProjectsView extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_projects_view, container, false);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                ...
                case 1: return OverviewFragment.newInstance();
                case 2: return ProgressFragment.newInstance();
                case 3: return CalendarFragment.newInstance();
                case 4: return TaskFragment.newInstance(1);
