...
public class ActivityProjectView extends AppCompatActivity implements FragmentTasks.OnListFragmentInteractionListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(globalProject == null){
            getProjectbyID get_task = new getProjectbyID(projectID);
            get_task.execute();
            try {
                get_task.get();
            }
        ...
        for(int i = 0; i <= 5; i++){
            ...
            if(fragment != null) {
                if (fragment instanceof FragmentChat) {
                    ...
                    String calendarID = globalProject.getCalendar();
                    f.updateTasks(calendarID);
                    ...
                    String calendarID = globalProject.getCalendar();
                    String userID = globalUser.getCalendar();
                    f.updateAllTasks(calendarID);
                    f.updateUserTasks(calendarID, userID);
    ...
    public class newTask extends AsyncTask<Void, Void, String>{
        ...
        public newTask(String name, String extra, String deadline){
            args = new String[3];
            args[0] = name;
            args[1] = "02/01/2016 12";
            args[2] = ActivityProjectView.this.globalProject.getCalendar();
            this.extra = extra;
        }
    ...
    public void addTaskMethod(String name, String email, String date){
